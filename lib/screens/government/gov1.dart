...
import 'package:myapp/screens/animal/animal1.dart';

class Gov1Screen extends StatelessWidget {
  const Gov1Screen ({Key? key}) : super(key: key);
  @override
...
Padding(
  padding: EdgeInsets.only(top: 10.0,left:10), // Adjust top padding if needed
  child: Row(
    mainAxisAlignment: MainAxisAlignment.spaceAround,
    children: [
      Padding(
...
Padding(
    padding: EdgeInsets.only(top: 70.0, left: 10.0,bottom:40), // Adjust top and left positioning
