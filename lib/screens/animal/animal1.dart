...
import 'package:myapp/screens/drivers/driver1.dart';

class Animal1Screen extends StatelessWidget {
  const Animal1Screen({Key? key}) : super(key: key);
  @override
                    ...
                    children: [
                      ...
                      InkWell(
                            ...
                            Navigator.push(
                                    context,
                                    MaterialPageRoute(
                                        builder: (context) => const Driver1Screen ()),
                                  );
                        },
                        child: Container(
  ...
  Widget customImage() {
    return SingleChildScrollView(
      ...
      children: [
            ...
            children: [
              ...
              Padding(
                  padding: const EdgeInsets.only(
                      top: 10.0,
                      left: 40,
                      right: 150), // Adjust space between a7 and a8
                  child: _buildImageWithTextBelow(
                    'images/a8.jpg',
                    ' ฉีดวัคซีน ',
                    width: 65,
        ...
        Padding(
          padding: const EdgeInsets.only(
              top: 20.0, left: 10.0), // Adjust top and left positioning
  ...
  Widget _buildImageWithTextBelow(String imageUrl, String text,
      {double width = 75, double height = 75}) {
    return Column(
      mainAxisAlignment: MainAxisAlignment.center,
      children: [
        Padding(
          padding: const EdgeInsets.only(
              bottom: 8.0), // Adjust the space between the image and the card
          child: Container(
            width: width,
            height: height,
            decoration: BoxDecoration(
