...
class Servicefriend2Screen extends StatelessWidget {
  const Servicefriend2Screen({Key? key}) : super(key: key);
  @override
      ...
      decoration: BoxDecoration(
       ...
       child: Column(
        children: [
          ...
          Padding(
    padding: const EdgeInsets.only(top: 6,), // Adjust top as needed
