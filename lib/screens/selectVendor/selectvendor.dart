            ...
            Column(
              ...
              children: [
                ...
                const Padding(
                 ...
                 myButton(),
                 Container(
  margin: EdgeInsets.only(left: 120,right:120, top: 10.0,bottom:40), // Adjust left and top values as needed
  width: 100.0, // Width of the container
  height: 102.0, // Height of the container
  decoration: BoxDecoration(
    image: DecorationImage(
      image: AssetImage('images/v1.png'), // Replace 'assets/image.png' with your image path
      fit: BoxFit.cover, // Adjust how the image covers the container
    ),
  ),
),
                 Padding(
  padding: EdgeInsets.only(bottom: 175.0), // Adjust the bottom padding as needed
  child: twoButtons(
    label1: 'ใช่',
    onPressed1: () {
