...
class Labor1Screen extends StatelessWidget {
  const Labor1Screen ({Key? key}) : super(key: key);
  @override
...
Padding(
  padding: EdgeInsets.only(top: 10.0,right:10), // Adjust top padding if needed
  child: Row(
    mainAxisAlignment: MainAxisAlignment.spaceAround,
    children: [
      Padding(
