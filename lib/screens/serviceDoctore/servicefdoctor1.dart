...
import 'package:myapp/screens/government/gov1.dart';

class ServiceDocotor1Screen extends StatelessWidget {
  const ServiceDocotor1Screen ({Key? key}) : super(key: key);
  @override
                      ...
                      InkWell(
                        onTap: () {
                              Navigator.push(
                                    context,
                                    MaterialPageRoute(
                                        builder: (context) => const Gov1Screen()),
                                  );
                        },
                        child: Container(
...
Padding(
    padding: const EdgeInsets.only(top: 70.0, left: 10.0,bottom:40), // Adjust top and left positioning
