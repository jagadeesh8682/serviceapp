...
import 'package:myapp/screens/registerVendor/registervendor5.dart';

class Registervendor4Screen extends StatelessWidget {
  const Registervendor4Screen({Key? key}) : super(key: key);
  @override
                      ...
                      InkWell(
                        onTap: () {
                          Navigator.push(
                            context,
                            MaterialPageRoute(
                                builder: (context) => const  Registervendor5Screen()),
                          );
                        },
                        child: Container(
    ...
    alignment: Alignment.centerLeft,
          ...
          const SizedBox(height: 30),
            textField2(),
              ...
              const SizedBox(height: 30), // Adjust spacing before the buttons
          Padding(
              ...
              children: [
                ...
                child:ElevatedButton(
                  ...
                  style: ElevatedButton.styleFrom(
                    padding: const EdgeInsets.symmetric(horizontal: 8), backgroundColor: const Color.fromARGB(255, 7, 8, 9),
