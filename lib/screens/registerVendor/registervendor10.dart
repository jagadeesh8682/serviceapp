...
import 'package:myapp/customwidget/radiobutton.dart';
import 'package:myapp/screens/registerVendor/registervendor11.dart';

class Registervendor10Screen extends StatelessWidget {
  const Registervendor10Screen({Key? key}) : super(key: key);
  @override
            ...
            Column(
              ...
              children: [
                      ...
                      InkWell(
                        onTap: () {
                          Navigator.push(
                            context,
                            MaterialPageRoute(
                                builder: (context) => const Registervendor11Screen()),
                          );
                        },
                        child: Container(
                ...
                const Padding(
                 ...
                 customText('เลือกแพคเกจประกัน'),
                 Padding(
  padding: EdgeInsets.symmetric(horizontal: 5), // Adjust the horizontal padding as needed
  child: Row(
    mainAxisAlignment: MainAxisAlignment.start,
    children: [
      customButton('แพคเกจ', width: 110),
      SizedBox(width: 1),
      customButton('ความคุ้มครอง', width: 140),
      SizedBox(width: 1),
      customButton('ราคา', width: 90),
    ],
  ),
),
 Radiobutton(),
  ...
  return Padding(
    padding: const EdgeInsets.only(top: 10, left: 20,bottom:20), // Adjust the values as needed
    child: Text(
      text,
      style: TextStyle(
        color: Color(0xFF5AC8FA),
        fontSize: 20,
        fontFamily: 'Roboto',
        height: 1.3, // Equivalent to lineHeight 26px in most cases
      ),
    ),
  );
}
 ...
 Widget customButton(String label, {required double width}) {
    return Container(
      width: width,
      height: 29,
      margin: EdgeInsets.all(6), // Adjust the margin as needed
      decoration: BoxDecoration(
        borderRadius: BorderRadius.circular(3),
        color: Color(0xFF526b8c), // Use the provided color
      ),
      child: ElevatedButton(
        ...
        child: Text(
          ...
          style: TextStyle(
            ...
            fontWeight: FontWeight.normal,
            height: 1.3, // Adjust line height if necessary
          ),
        ),
      ),
    );
  ...
  Widget profile() {
    ...
    child: Container(
      ...
      child: Form(
        ...
        child: Column(
          children: [
            imageContainer( 'images/text1.png',) ,
            checkBoxWithText(),
  ...
  return Row(
    children: [
      customCheckbox(true),
      Padding(padding: EdgeInsets.only( left: 17,bottom:10),
 ...
 Widget customCheckbox(bool isChecked) {
  return Container(
    margin: const EdgeInsets.only( left:17,bottom:10),
    width: 21,
    height: 22,
    decoration: BoxDecoration(
 ...
 Widget imageContainer(String imageUrl,) {
  return Container(
    margin: const EdgeInsets.only(top: 20, left: 29,right:29,bottom:10),
    width: 218,
    height: 100,
    decoration: BoxDecoration(
