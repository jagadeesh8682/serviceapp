...
import 'package:myapp/screens/registerVendor/registervendor3.dart';

class Registervendor2Screen extends StatelessWidget {
  const Registervendor2Screen({Key? key}) : super(key: key);
  @override
                      ...
                      InkWell(
                        onTap: () {
                          Navigator.push(
                            context,
                            MaterialPageRoute(
                                builder: (context) => const  Registervendor3Screen()),
                          );
                        },
                        child: Container(
          ...
          child: InputDecorator(
            ...
            child: Row(
              ...
              children: [
                ...
                Icon(Icons.arrow_drop_down, color: Color(0xFF030303)),
              ],
            ),
          ),
        ),
